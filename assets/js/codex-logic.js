...
if (form) {
    form.addEventListener('submit', async function (e) {
        ...
        if (!isLegalChecked) {
            alert("Debes aceptar los términos legales y la cesión de rendimientos para continuar.");
            return;
        }
...
async function generateContractPDF(data) {
    ...
    SEGUNDA. GARANTÍA DIGITAL: El HUÉSPED constituye una garantía mediante depósito de activos digitales en la Bóveda Multisig designada por EL OPERADOR.

    TERCERA. CESIÓN DE FRUTOS: El HUÉSPED cede expresamente a favor de EL OPERADOR cualquier rendimiento, staking reward, yield o interés generado por los activos digitales depositados como garantía, como contraprestación por los servicios de gestión tecnológica y custodia segura.

    CUARTA. DERECHO DE RETENCIÓN: En caso de impago del canon de hospedaje, EL OPERADOR podrá ejercer el derecho de retención sobre los bienes del HUÉSPED y ejecutar la garantía digital de forma inmediata.

    QUINTA. PENALIDAD POR SERVICIOS: El HUÉSPED autoriza el descuento automático de la garantía para cubrir servicios públicos o expensas impagas al momento de la restitución.
        `;
    ...
    SEGUNDA. TARIFA DE ALMACENAJE: El pago mensual corresponde exclusivamente a la tarifa de custodia y administración logística.

    TERCERA. DERECHO DE RETENCIÓN (ART. 1177 C.Co): El DEPOSITARIO ejercerá derecho de retención sobre las mercancías depositadas hasta el pago total de las sumas adeudadas por custodia.

    CUARTA. GARANTÍA Y YIELD: La garantía digital depositada generará rendimientos financieros que son cedidos en su totalidad al DEPOSITARIO como remuneración parcial por la gestión de la billetera de seguridad.
        `;
    ...
    PRIMERA. ATIPICIDAD: Este contrato es ATÍPICO de Concesión de Espacio y Servicios. Las partes declaran expresamente que NO APLICA la legislación de arrendamiento de locales comerciales.

    SEGUNDA. RENUNCIA A PRIMA (ART. 518 C.Co): Dada la naturaleza de servicios integrales (${data.servicios}) que incluye este contrato, EL CONCESIONARIO renuncia expresamente a cualquier derecho de renovación automática, prima comercial o indemnización por terminación.
